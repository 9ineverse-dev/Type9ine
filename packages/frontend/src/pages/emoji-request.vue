...
const agreement = [
	'次の要素に該当する絵文字の場合、却下若しくは削除の対象となる可能性があります。予めご了承ください。</br>・利用規約第６条に定める禁止事項に該当する恐れのあるemoji</br>・第三者の商標権、著作権等を侵害する恐れのあるemoji</br>・オリジナル絵文字申請の場合、申請者ご自身に著作権がないemoji</br>・登録申請に不備があるemoji',
	...
	'絵文字の削除・訂正申請は、これが権利の濫用に該当しないものに限り受理します。</br>（例：・絵文字が他人の著作権を侵害しうることが後から発覚した場合</br>・自身の著作物である絵文字が、他人によって不正に実装された場合</br>・絵文字が一般的に誹謗中傷等の不法行為に用いられており、かつその利用用途について絵文字申請者が同意していない場合</br>・絵文字の削除によるシステム的損害やユーザーの損害と照らし合わせて、なお削除すべき相応の理由がある場合</br>・他、絵文字の削除について、株式会社9ineverseが同意できる場合（同意による契約解除）等）</br>これらの申請は9ineverse.comサポートアカウントへのDMより申請してください。',
];
